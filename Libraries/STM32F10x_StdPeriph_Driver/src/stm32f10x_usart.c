...
/**
  ...
  */
void
USART_ClockInit(USART_TypeDef * USARTx,
...
/*---------------------------- USART CR2 Configuration -----------------------*/
	...
	tmpreg |=
	    ...
	    USART_CPOL | USART_ClockInitStruct->USART_CPHA |
...
/**
  ...
  */
void
USART_LINBreakDetectLengthConfig(USART_TypeDef * USARTx,
				 uint16_t USART_LINBreakDetectLength)
{
	/* Check the parameters */
	assert_param(IS_USART_ALL_PERIPH(USARTx));
	assert_param(IS_USART_LIN_BREAK_DETECT_LENGTH
