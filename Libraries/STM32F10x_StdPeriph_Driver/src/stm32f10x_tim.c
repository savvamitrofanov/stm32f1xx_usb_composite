...
/**
  ...
  */
void
TIM_TimeBaseInit(TIM_TypeDef * TIMx,
		 TIM_TimeBaseInitTypeDef * TIM_TimeBaseInitStruct)
{
	...
	if ((TIMx == TIM1) || (TIMx == TIM8) || (TIMx == TIM2) || (TIMx == TIM3)
		...
		tmpcr1 &=
		    (uint16_t) (~((uint16_t) (TIM_CR1_DIR | TIM_CR1_CMS)));
...
void TIM_ICInit(TIM_TypeDef * TIMx, TIM_ICInitTypeDef * TIM_ICInitStruct)
{
	...
	if ((TIMx == TIM1) || (TIMx == TIM8) || (TIMx == TIM2) || (TIMx == TIM3)
	    || (TIMx == TIM4) || (TIMx == TIM5)) {
		assert_param(IS_TIM_IC_POLARITY
			     (TIM_ICInitStruct->TIM_ICPolarity));
	} else {
		assert_param(IS_TIM_IC_POLARITY_LITE
			     (TIM_ICInitStruct->TIM_ICPolarity));
	}
...
TIM_BDTRConfig(TIM_TypeDef * TIMx, TIM_BDTRInitTypeDef * TIM_BDTRInitStruct)
{
	...
	assert_param(IS_TIM_BREAK_POLARITY
...
/**
  ...
  */
void
TIM_DMAConfig(TIM_TypeDef * TIMx, uint16_t TIM_DMABase,
...
/**
  ...
  */
void
TIM_TIxExternalClockConfig(TIM_TypeDef * TIMx,
			   ...
			   uint16_t TIM_ICPolarity, uint16_t ICFilter)
{
	...
	if (TIM_TIxExternalCLKSource == TIM_TIxExternalCLK1Source_TI2) {
		TI2_Config(TIMx, TIM_ICPolarity, TIM_ICSelection_DirectTI,
			   ICFilter);
	} else {
		TI1_Config(TIMx, TIM_ICPolarity, TIM_ICSelection_DirectTI,
			   ICFilter);
	}
...
/**
  ...
  */
void
TIM_ETRClockMode1Config(TIM_TypeDef * TIMx, uint16_t TIM_ExtTRGPrescaler,
...
/**
  ...
  */
void
TIM_ETRConfig(TIM_TypeDef * TIMx, uint16_t TIM_ExtTRGPrescaler,
	      uint16_t TIM_ExtTRGPolarity, uint16_t ExtTRGFilter)
{
	uint16_t tmpsmcr = 0;
	/* Check the parameters */
...
/**
  ...
  */
void
TIM_PrescalerConfig(TIM_TypeDef * TIMx, uint16_t Prescaler,
			   ...
			   uint16_t TIM_IC1Polarity, uint16_t TIM_IC2Polarity)
{
	...
	tmpccer &=
	    (uint16_t) (((uint16_t) ~ ((uint16_t) TIM_CCER_CC1P)) &
...
TIM_SelectOCxM(TIM_TypeDef * TIMx, uint16_t TIM_Channel, uint16_t TIM_OCMode)
{
	...
	if ((TIM_Channel == TIM_Channel_1) || (TIM_Channel == TIM_Channel_3)) {
		...
		*(__IO uint32_t *) tmp &=
		    (uint32_t) ~ ((uint32_t) TIM_CCMR1_OC1M);
...
/**
  ...
  */
static void
TI1_Config(TIM_TypeDef * TIMx, uint16_t TIM_ICPolarity,
	   uint16_t TIM_ICSelection, uint16_t TIM_ICFilter)
{
	...
	if ((TIMx == TIM1) || (TIMx == TIM8) || (TIMx == TIM2) || (TIMx == TIM3)
		...
		tmpccer &= (uint16_t) ~ ((uint16_t) (TIM_CCER_CC1P));
		tmpccer |=
		    (uint16_t) (TIM_ICPolarity | (uint16_t) TIM_CCER_CC1E);
	} else {
		/* Select the Polarity and set the CC1E Bit */
		tmpccer &=
		    (uint16_t) ~ ((uint16_t) (TIM_CCER_CC1P | TIM_CCER_CC1NP));
		tmpccer |=
		    (uint16_t) (TIM_ICPolarity | (uint16_t) TIM_CCER_CC1E);
	}
...
/**
  ...
  */
static void
TI2_Config(TIM_TypeDef * TIMx, uint16_t TIM_ICPolarity,
	   uint16_t TIM_ICSelection, uint16_t TIM_ICFilter)
{
	...
	if ((TIMx == TIM1) || (TIMx == TIM8) || (TIMx == TIM2) || (TIMx == TIM3)
		...
		/* Select the Polarity and set the CC2E Bit */
		tmpccer &=
		    (uint16_t) ~ ((uint16_t) (TIM_CCER_CC2P | TIM_CCER_CC2NP));
		tmpccer |=
		    (uint16_t) (TIM_ICPolarity | (uint16_t) TIM_CCER_CC2E);
	}
...
/**
  ...
  */
static void
TI3_Config(TIM_TypeDef * TIMx, uint16_t TIM_ICPolarity,
	   uint16_t TIM_ICSelection, uint16_t TIM_ICFilter)
{
	...
	if ((TIMx == TIM1) || (TIMx == TIM8) || (TIMx == TIM2) || (TIMx == TIM3)
		...
		/* Select the Polarity and set the CC3E Bit */
		tmpccer &=
		    (uint16_t) ~ ((uint16_t) (TIM_CCER_CC3P | TIM_CCER_CC3NP));
		tmpccer |=
		    (uint16_t) (TIM_ICPolarity | (uint16_t) TIM_CCER_CC3E);
	}
...
/**
  ...
  */
static void
TI4_Config(TIM_TypeDef * TIMx, uint16_t TIM_ICPolarity,
	   uint16_t TIM_ICSelection, uint16_t TIM_ICFilter)
{
	uint16_t tmpccmr2 = 0, tmpccer = 0, tmp = 0;
	...
	if ((TIMx == TIM1) || (TIMx == TIM8) || (TIMx == TIM2) || (TIMx == TIM3)
		...
		/* Select the Polarity and set the CC4E Bit */
		tmpccer &=
		    (uint16_t) ~ ((uint16_t) (TIM_CCER_CC3P | TIM_CCER_CC4NP));
		tmpccer |=
		    (uint16_t) (TIM_ICPolarity | (uint16_t) TIM_CCER_CC4E);
	}
	/* Write to TIMx CCMR2 and CCER registers */
	TIMx->CCMR2 = tmpccmr2;
	TIMx->CCER = tmpccer;
