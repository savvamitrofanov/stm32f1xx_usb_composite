...
/**
  ...
  */
void
ADC_RegularChannelConfig(ADC_TypeDef * ADCx, uint8_t ADC_Channel,
...
/**
  ...
  */
void
ADC_ExternalTrigInjectedConvConfig(ADC_TypeDef * ADCx,
...
/**
  ...
  */
void
ADC_InjectedChannelConfig(ADC_TypeDef * ADCx, uint8_t ADC_Channel,
			  uint8_t Rank, uint8_t ADC_SampleTime)
{
...
/**
  ...
  */
void
ADC_SetInjectedOffset(ADC_TypeDef * ADCx, uint8_t ADC_InjectedChannel,
		      uint16_t Offset)
{
	__IO uint32_t tmp = 0;
...
/**
  ...
  */
void
ADC_AnalogWatchdogThresholdsConfig(ADC_TypeDef * ADCx,
